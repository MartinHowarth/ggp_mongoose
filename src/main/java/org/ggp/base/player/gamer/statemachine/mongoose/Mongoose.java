...
public class Mongoose extends SampleGamer {
    /*
...
//                System.out.println("Excluding bad move: " + jointMove.get(theRoleIndex));
    ...
    Move bestMoveCompleteTree(StateMachine theMachine, MachineState theState, Role theRole) throws MoveDefinitionException, TransitionDefinitionException, GoalDefinitionException{
        /*
    ...
    Move bestMoveVariableDepth(StateMachine theMachine, MachineState theState, Role theRole) throws MoveDefinitionException, TransitionDefinitionException, GoalDefinitionException{
        /*
        Implements the alpha-beta minimax player. http://logic.stanford.edu/ggp/chapters/chapter_06.html

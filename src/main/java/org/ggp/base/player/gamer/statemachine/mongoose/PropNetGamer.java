...
public abstract class PropNetGamer extends Gamer {
     ...
     * @return
     */
    public abstract PropNetStateMachine getInitialStateMachine();
     ...
     */
    public final PropNetStateMachine getStateMachine()
    {
        return stateMachine;
    }
     ...
     */
    protected final void switchStateMachine(PropNetStateMachine newStateMachine) {
        try {

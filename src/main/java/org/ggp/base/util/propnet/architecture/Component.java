...
public abstract class Component implements Serializable
{
    ...
    /** The in-progress values of the inputs to this component */
    ...
    public abstract void setValue(boolean boo);

    /**
     * Receive an input as part of propagation. If all input have been received, return true.
     * If true is returned, then call getValue() and continue propagation.
     * @return
     */
    public boolean receiveInput() {
        inputCounter++;
        if (inputCounter == getInputs().size()) {
            return true;
        }
        return false;
    }
